...
|---|---|---|
| `relaxed atomic (store+load)` | [`m_atomica_relaxed`](medicoes/custo-espera.c#L171) | [`grupo_primitivo`](medicoes/custo-espera.c#L311) |
...
| `atomic + busy wait` | [`m_repasse_atomica`](medicoes/custo-espera.c#L396) | [`main`](medicoes/custo-espera.c#L514) |
| `mutex + busy wait` | [`m_repasse_mutex_ativo`](medicoes/custo-espera.c#L422) | same |
| `mutex + condvar (SLEEPS)` | [`m_repasse_condvar`](medicoes/custo-espera.c#L457) | same |
| `POSIX semaphore (SLEEPS)` | [`m_repasse_semaforo`](medicoes/custo-espera.c#L486) | same |
...
| A section of unpredictable duration | mutex | sleeping is acceptable outside the hot path | [`m_mutex_simples`](medicoes/custo-espera.c#L182), [`m_repasse_mutex_ativo`](medicoes/custo-espera.c#L422) |
| Waiting for an event that may take long | condvar / semaphore | frees the CPU; **never** on the hot path | [`m_repasse_condvar`](medicoes/custo-espera.c#L457), [`m_repasse_semaforo`](medicoes/custo-espera.c#L486) |
