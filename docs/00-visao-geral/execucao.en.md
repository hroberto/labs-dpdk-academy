...
compiler, DPDK, Meson and Ninja, per the [tooling document](ferramental.en.md). Run
...
[§2.4 Ownership: who frees](../03-mempool-ring-mbuf/README.en.md#24-ownership-who-frees).
...
was never written.
To study the complete mechanism, follow the [practical topic](../../trilha/01-fundamentos/02-mempool-ring/README.en.md).

## Reading a table

Start with the module's own tables: the
[cost of the ring](../03-mempool-ring-mbuf/README.en.md#3-the-ring-the-price-of-generality)
...
The [runtime module](../02-runtime-dpdk/README.en.md#10-when-it-goes-wrong) describes
...
Continue through the [track](../../trilha/README.en.md) according to the mechanism you
want to investigate. The [validation policy](validacao.en.md) distinguishes what was
written, implemented, tested and measured.

Follow the contracts and pending items in the
[ROADMAP](../../ROADMAP.en.md). The campaigns that support quantitative comparisons
live in the [validation matrix](validacao.en.md).
